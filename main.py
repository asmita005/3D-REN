...
center_dir = r'/home2/mittal/project/3D-CNN/datasets/msra_center'
keypoints_num = 21
test_subject_id = 3
cubic_size = 200
...
def transform_train(sample):
    ...
    input, output = voxelization_train({'points': points, 'keypoints': keypoints, 'refpoint': refpoint})
    keypoints1 = np.array(output.flat)
